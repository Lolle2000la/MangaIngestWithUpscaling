...
| `UpscaleTimeout` | `Ingest_Upscaler__UpscaleTimeout` | `00:01:00` | Per-million-pixel inactivity timeout (`hh:mm:ss`). The effective timeout is scaled by image size — see [Upscaling Timeout](UPSCALING_TIMEOUT.md). |
