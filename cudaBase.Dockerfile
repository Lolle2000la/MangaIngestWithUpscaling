...
RUN python3 -m venv ./pyenv && \
    ...
    ./pyenv/bin/python -m pip install --no-cache-dir chainner_ext==0.3.10 numpy==2.2.5 opencv-python-headless==4.11.0.86 \
	...
	./pyenv/bin/python -m pip uninstall -y torch torchvision || \
	./pyenv/bin/python -m pip install --no-cache-dir torch==2.7.1 torchvision==0.22.1 --index-url https://download.pytorch.org/whl/cu118 || \
    ./pyenv/bin/python -m pip install --no-cache-dir torch torchvision --index-url https://download.pytorch.org/whl/cu118
