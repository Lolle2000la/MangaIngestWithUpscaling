...
#   Ingest_Upscaler__PreferredGpuBackend=CUDA_12_8
...
FROM ${BASE_IMAGE}
# Override the GPU backend for CUDA 12.8
...
LABEL org.opencontainers.image.description="DEPRECATED: Use the standard image with Ingest_Upscaler__PreferredGpuBackend=CUDA_12_8. This image will be removed in a future release."
