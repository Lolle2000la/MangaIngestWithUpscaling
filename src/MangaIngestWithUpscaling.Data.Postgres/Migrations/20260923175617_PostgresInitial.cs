...
namespace MangaIngestWithUpscaling.Data.Postgres.Migrations
{
    ...
    public partial class PostgresInitial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(
                "CREATE INDEX \"IX_PersistedTasks_ChapterId\" ON \"PersistedTasks\" ((\"Data\"->>'ChapterId'));"
            );
            migrationBuilder.Sql(
                "CREATE INDEX \"IX_PersistedTasks_Type_ChapterId\" ON \"PersistedTasks\" ((\"Data\"->>'$type'), (\"Data\"->>'ChapterId'));"
            );
        }
