...
RUN python3 -m venv ./pyenv && \
    ...
    ./pyenv/bin/python -m pip install --no-cache-dir torch==2.9.1 torchvision==0.24.1 --extra-index-url https://download.pytorch.org/whl/cu128 \
        ...
        sanic==24.6.0 spandrel_extra_arches==0.2.0 spandrel==0.4.1 packaging==25.0 pillow==11.1.0
